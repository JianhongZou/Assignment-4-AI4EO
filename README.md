...
base_path = "/content/drive/MyDrive/AI4EO/week4/Unsupervised Learning/S2A_MSIL1C_20190301T235611_N0207_R116_T01WCU_20190302T014622.SAFE/GRANULE/L1C_T01WCU_A019275_20190301T235610/IMG_DATA/" # You need to specify the path
bands_paths = {
...
```pyhton
flag_cleaned_modified = flag_cleaned - 1 #Define
```
```python
